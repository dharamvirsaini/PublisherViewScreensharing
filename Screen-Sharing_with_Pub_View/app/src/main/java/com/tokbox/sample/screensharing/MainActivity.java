    ...
    private Session.SessionListener sessionListener = new Session.SessionListener() {
        ...
        public void onConnected(Session session) {
           ...
           // ImageView im = new ImageView(MainActivity.this);
            ...
            ScreenSharingCapturer screenSharingCapturer = new ScreenSharingCapturer(MainActivity.this, parentLayout);

            Publisher screenSharingPublisher = new Publisher.Builder(MainActivity.this)
                    .capturer(screenSharingCapturer)
                    .build();

            screenSharingPublisher.setPublisherVideoType(PublisherKit.PublisherKitVideoType.PublisherKitVideoTypeScreen);
