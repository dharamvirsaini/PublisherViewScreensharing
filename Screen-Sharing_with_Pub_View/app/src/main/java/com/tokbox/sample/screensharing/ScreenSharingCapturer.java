...
public class ScreenSharingCapturer extends BaseVideoCapturer {
  ...
  private Context context;
    ...
    private int[] frame;
    private float publisherX;
    private float publisherY;
    private TextureView publisherTextureView;
    ...
    private Runnable newFrame = new Runnable() {
        ...
        public void run() {
            if (capturing) {
                ...
                canvas.drawBitmap(publisherTextureView.getBitmap(), publisherX, publisherY, null);
    ...
    public ScreenSharingCapturer(Context context, View view) {
        ...
        publisherX = activity.findViewById(R.id.publisherview).getX();
        publisherY = activity.findViewById(R.id.publisherview).getY();

        publisherTextureView = (TextureView) activity.getPublisher().getView();
    }
